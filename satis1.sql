...
CREATE TABLE Respuesta (
  ...
  foro_codforo INTEGER NOT NULL,
  respuesta TEXT NULL,
  PRIMARY KEY(idRespuesta, foro_codforo),
  FOREIGN KEY(foro_codforo)
    REFERENCES foro(codforo)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION
);
...
CREATE TABLE Proyecto (
  ...
  vigente BOOL NULL,
  PRIMARY KEY(codProyecto, Consultor_idConsultor, Consultor_Usuario_idUsuario),
  FOREIGN KEY(Consultor_idConsultor, Consultor_Usuario_idUsuario)
    REFERENCES Consultor(idConsultor, Usuario_idUsuario)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION
