	...
	var tocalendar = function() {
		...
		for(var o = 0; o<ev.length;o++) {
                    if (ev[o]['name']=="Reunion semanal de seguimiento")
                    {
                        ...
                        $(".specific-day-scheme").append('<div class="specific-day-scheme-event"><a href= "../Vista/iu.HitoPagableGrupoEmpresa.html"><h1>'+ev[o]['name']+'</h1></a><p data-role="dur">'+ev[o]['start']+' '+ev[o]['end']+'</p><p data-role="loc">'+ev[o]['location']+'</p></div>');
