...
require '../Controlador/Conexion.php';
    function retornarNombreDelConsultor($codC, $codUsuarioC){
        $conec=new Conexion(); 
        $con=$conec->getConection();
        $sql="SELECT nombreconsultor FROM consultor c WHERE c.idconsultor='$codC' AND c.usuario_idusuario='$codUsuarioC'";
