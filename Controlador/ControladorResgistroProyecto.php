...
require ('../Modelo/ModeloRegistroProyecto.php');
    ...
    $fecha_fin_proyecto = $_POST['fecha_fin_proyecto'];
     if(verificarSiExisteCodigoDelProyecto($codigo_proyecto)){
    ...
    }  else if (verificarSiExisteProyecto($codigo_proyecto, $codC, $nombre_proyecto, $fecha_fin_proyecto )){
        ...
        insertarProyecto($codigo_proyecto, $codC, $nombre_proyecto, $fecha_fin_proyecto);
